                ...
                <div class="col-lg-6 d-flex w-100 ">
                    <div class="card flex-grow-1 ">
                        <div class="card-header">
                            <h4>Detail Pendampingan Aplikasi</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-12 col-sm-12 col-md-8">
                                    <div class="tab-content no-padding" id="myTab2Content">
                                        ...
                                        <div class="tab-pane fade" id="profile4" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                <label for="nik">Agenda</label>
                                                <select disabled="true" class="form-control" value="<?= $agenda ?>">
                                                    <option value="0">Pembahasan Proses Bisnis dan Requirement System
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled="true" type="text" value="<?= $nama_aplikasi ?>"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Deskripsi Aplikasi</label>
                                                <textarea disabled="true" rows="4"
                                                    class="form-control"><?= $deskripsi_aplikasi ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Tanggal</label>
                                                <input type="datetime-local" class="form-control" type="date"
                                                    disabled="true" value="<?= $tgl ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Tempat</label>
                                                <textarea disabled="true" rows="4"
...
function access_button() {
    ...
    if (<?= session()->get('id_role') ?> == 0 || <?= session()->get('id_role') ?> == 2) {
        ...
        button +=
            '<a href="<?= base_url(session()->get('role') . '/form') ?>" 
