    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Pengaduan Jaringan</div>
            </div>
        </div>
                ...
                <div class="col-lg-6 d-flex w-100 ">
                    <div class="card flex-grow-1 ">
                        <div class="card-header">
                            <h4>Detail Pengaduan Jaringan</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="tab-content no-padding" id="myTab2Content">
                                        ...
                                        <div class="tab-pane fade" id="profile4" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" type="date" disabled="true"
                                                    value="<?= $tgl_kejadian ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Keluhan</label>
                                                <textarea rows="4" disabled="true"
                                                    class="form-control"><?= $keluhan ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Tindak Lanjut Teknisi</label>
                                                <textarea rows="4" id="keluhan"
                                                    class="form-control"><?= $tindak_lanjut ?></textarea>
                                            </div>
                                        ...
                                        <div class="tab-pane fade show" id="file4" role="tabpanel"
                                            ...
                                            <div class="row mt-4 table-responsive">
                                                <table id="example" class="table table-sm" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <?php for ($x = 0; $x < count($foto); $x++): ?>
                                                            <tr>
                                                            <td style="white-space: nowrap; width: 1%;">
                                                                <a href="javascript:void(0)"
                                                                onclick="window.open('<?= base_url() ?>/public/assets/berkas/dokumentasi/<?= $foto[$x] ?>')"
                                                                class="btn btn-primary btn-action mr-1"
                                                                data-toggle="tooltip" title="Unduh">
    ...
    if ($status == 1) {
        if (document.getElementById("keluhan").value == "") {
            Swal.fire({
                icon: 'error',
                title: 'Gagal...',
                text: 'Tindak Lanjut Terhadap Tiket Kosong !'
            });
        } else if (isEmptyOrSpaces(document.getElementById('keluhan').value)) {
            Swal.fire({
                icon: 'error',
                title: 'Gagal...',
                text: 'Tindak Lanjut Terhadap Tiket Kosong !'
            });
        } else if (/[^a-zA-Z0-9\ .,-_\n]/.test(document.getElementById("keluhan").value)) {
            Swal.fire(
                'Gagal',
                "Form Tindak Lanjut tidak sesuai format.",
                'error'
            );
        } else {
            Swal.fire({
...
function update_meeting() {
    if (document.getElementById("keluhan").value == "") {
        ...
        formData.append('tindak_lanjut', document.getElementById("keluhan").value.toString());

        $.ajax({
            url: "<?= base_url() ?>/detail/update_jaringan",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
