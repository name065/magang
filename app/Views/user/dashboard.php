...
<section class="section">
    ...
    <div class="dash-header">
        ...
        <p>Dashboard Magang — <?= date('l, d F Y') ?></p>
    </div>
            ...
            <div class="stat-card">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        ...
                        <div class="stat-value" id="jurusan">—</div>
                    </div>
                    <div class="stat-icon icon-amber"><i class="fas fa-graduation-cap"></i></div>
                </div>
                <div class="stat-sub">
                    Civitas: <strong id="jumlah_total">—</strong>
                </div>
            </div>
        </div>
...
function tiket_count_user() {
    $.ajax({
        ...
        success: function(d) {
            document.getElementById("jurusan").innerHTML = d["jurusan"];
            document.getElementById("jumlah_total").innerHTML = d["civitas"];
        }
    });
}
</script>
