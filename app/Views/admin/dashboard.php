...
<style>
    ...
    .stat-mini .num { font-size: 15px; font-weight: 700; }
    ...
    .calendar-card .fc-toolbar-title { font-size: 14px !important; font-weight: 700 !important; }
    .calendar-card input[type="month"] {
        border: 1.5px solid #e0e4f0; border-radius: 10px;
        padding: 6px 12px; font-size: 13px; outline: none;
        margin-bottom: 12px;
    }
    .calendar-card input[type="month"]:focus { border-color: #6366f1; }
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="stat-card">
                ...
                <div class="stat-row">
                    <div class="stat-mini">
                        <div class="num" style="color:#6366f1;"><?= $count_verifikator ?></div>
                        <div class="lbl">Verifikator</div>
                    </div>
                    <div class="stat-mini">
                        <div class="num" style="color:#3b82f6;"><?= $count_operator ?></div>
                        <div class="lbl">Operator</div>
                    </div>
                    <div class="stat-mini">
                        <div class="num" style="color:#8b5cf6;"><?= $count_magang ?></div>
    ...
    <div class="row">
        <div class="col-12 mb-3">
            <div class="calendar-card">
                <div class="chart-card-title mb-3"><i class="fas fa-calendar-alt mr-2" style="color:#6366f1;"></i>Kalender Pelayanan Publik</div>
                <input type="month" onchange="change_calendar()" class="form-control" id="tgl_now" style="max-width:200px;">
                <div id="calendar"></div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="calendarModal" tabindex="-1" role="dialog" aria-labelledby="calendarModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius:16px; border:none;">
            <div class="modal-header" style="background:linear-gradient(135deg,#6366f1,#818cf8); border-radius:16px 16px 0 0;">
                <h5 class="modal-title text-white" id="calendarModalLabel"><i class="fas fa-ticket-alt mr-2"></i>Detail Tiket</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Nama Pelayanan</label>
                    <input type="text" id="modal_acara" class="form-control" disabled style="border-radius:10px;">
                </div>
                <div class="form-group">
                    <label>Tanggal Pengajuan</label>
                    <input type="datetime-local" class="form-control" id="modal_tgl_akhir" disabled style="border-radius:10px;">
                </div>
                <div class="form-group">
