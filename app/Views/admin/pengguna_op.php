    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<?= base_url() ?>/admin/pengguna/operator">Data Master
                        Pengguna</a>
                </div>
        ...
        <div class="section-body">
            <div class="row mt-4">
                <div class="col-lg-8 d-flex w-100 ">
                    <div class="card flex-grow-1 ">
                        <div class="card-header">
                            <h4>Daftar Pengguna Operator</h4>
                        </div>
                        <div class="card-body">
                            <div class="">
                ...
                <div class="col-lg-4 d-flex w-100 ">
                    <div class="card flex-grow-1 ">
                        <div class="card-header">
                            <h4>Form Tambah Pengguna Operator</h4>
                        </div>
                        <div class="card-body">
...
function tambah_user() {
    ...
    if (document.getElementById('nama').value == "" || isEmptyOrSpaces(document.getElementById('nama').value)) {
        ...
        $.ajax({
            url: "<?= base_url() ?>/admin/pengguna/set_op",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
...
function ubah_user($id) {
    ...
    if (document.getElementById('nama').value == "" || isEmptyOrSpaces(document.getElementById('nama').value)) {
        ...
        $.ajax({
            url: "<?= base_url() ?>/admin/pengguna/update_op",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
...
function get_data() {
    var table = $('#example').DataTable({
        ...
        "ajax": {
            "type": "GET",
            "url": "<?= base_url() ?>/admin/pengguna/get_operator",
            "dataSrc": "",
            "data": function(data) {
